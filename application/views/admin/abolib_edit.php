        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 center-column">
                    <form action="<?php echo site_url('admin/Abolib/edit') ?>" method="post" class="cmxform" enctype="multipart/form-data">
                    <input type="hidden" name="abo_libimg_id" value="<?php echo $info['abo_libimg_id'] ?>" class="form-control">
                        <div class="panel">
                            <div class="panel-heading">
                                <div class="panel-title">修改类型</div>
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">标题</span>
                                            <input type="text" name="abo_libimg_title" value="<?php echo $info['abo_libimg_title'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">英文标题</span>
                                            <input type="text" name="abo_libimg_etitle" value="<?php echo $info['abo_libimg_etitle'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">分类</span>
                                            <select name="abo_type_id" id="standard-list1" class="form-control">
                                               <?php foreach($type as $item){ ?>
                                                <option value="<?php echo $item['abo_id'] ?>" <?php if($info['abo_type_id']==$item['abo_id']){echo "selected='true'";} ?>><?php  echo $item['abo_title']?></option>
                                    ...
                                    <div>
                                       ...
                                       <div class="fileinput fileinput-new" data-provides="fileinput"  id="exampleInputUpload">
                                           <div class="fileinput-new thumbnail" style="width: 200px;height: auto;max-height:150px;">
                                               <img id='picImg' style="width: 100%;height: auto;max-height: 140px;" src="<?php echo base_url($info['abo_libimg_img']) ?>" alt="" />
                                           </div>
