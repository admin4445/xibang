        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 center-column">
                    <form action="<?php echo site_url('admin/News/add') ?>" method="post" class="cmxform" enctype="multipart/form-data">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">标题</span>
                                            <input type="text" name="news_title" value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">作者</span>
                                            <input type="text" name="news_author" value="" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">分类</span>
                                            <select name="news_type_id" id="standard-list1" class="form-control">
                                               <?php foreach($newtype as $item){ ?>
                                                <option value="<?php echo $item['news_type_id'] ?>"><?php  echo $item['news_name']?></option>
