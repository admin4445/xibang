        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 center-column">
                    <form action="<?php echo site_url('admin/About/edit') ?>" method="post" class="cmxform" enctype="multipart/form-data">
                    <input type="hidden" name="abo_id" value="<?php echo $info['abo_id'] ?>" class="form-control">
                        <div class="panel">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">标题</span>
                                            <input type="text" name="abo_title" value="<?php echo $info['abo_title'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">英文标题</span>
                                            <input type="text" name="abo_en_title" value="<?php echo $info['abo_en_title'] ?>" class="form-control">
                                        </div>
                                    </div>
