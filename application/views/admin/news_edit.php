        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 center-column">
                    <form action="<?php echo site_url('admin/News/edit') ?>" method="post" class="cmxform" enctype="multipart/form-data">
                    <input type="hidden" name="news_id" value="<?php echo $info['news_id'] ?>" class="form-control">
                        <div class="panel">
                                ...
                                <div class="col-md-7">
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">标题</span>
                                            <input type="text" name="news_title" value="<?php echo $info['news_title'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">作者</span>
                                            <input type="text" name="news_author" value="<?php echo $info['news_author'] ?>" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group"><span class="input-group-addon">分类</span>
                                            <select name="news_type_id" id="standard-list1" class="form-control">
                                               <?php foreach($newtype as $item){ ?>
                                                <option value="<?php echo $item['news_type_id'] ?>" <?php if($info['news_type_id']==$item['news_type_id']){echo "selected='true'";} ?>><?php  echo $item['news_name']?></option>
                                    ...
                                    <div>
                                       ...
                                       <div class="fileinput fileinput-new" data-provides="fileinput"  id="exampleInputUpload">
                                           <div class="fileinput-new thumbnail" style="width: 200px;height: auto;max-height:150px;">
                                               <img id='picImg' style="width: 100%;height: auto;max-height: 140px;" src="<?php echo base_url($info['news_img']) ?>" alt="" />
                                           </div>
