        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 center-column">
                    <form action="<?php echo site_url('admin/Cases/add') ?>" method="post" class="cmxform" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group"><span class="input-group-addon">分类</span>
                                            <select name="case_type_id" id="standard-list1" class="form-control">
                                               <?php foreach($casetype as $item){ ?>
                                                <option value="<?php echo $item['case_type_id'] ?>"><?php  echo $item['case_type_name']?></option>
